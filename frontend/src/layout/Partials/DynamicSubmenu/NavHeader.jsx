  ...
  return (
    <NavTopDraw>
      <Flex spacebetween={'true'} aligncenter={'true'} H_100={'true'}>
        ...
        <h3 style={{ color: '#990000', fontFamily: '"Raleway", sans-serif', fontWeight: 700 }} className="ResponMobile">
          {AllManagementDetails?.temple_name}</h3>
        <p style={{ color: '#990000', fontFamily: '"Raleway", sans-serif', fontSize: 25, fontWeight: 700 }}>
          {nameDetails}</p>
      </Flex>
    </NavTopDraw>
  );
